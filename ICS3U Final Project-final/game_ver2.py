...
bg = pygame.image.load("water.png")
...
# create subclasses of obstacles to create different appearances, animations, etc.

# Create a function to run the game
def game():
    global obstacles, game_speed, y_pos
